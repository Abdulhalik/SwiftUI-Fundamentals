//
//  StateAndBindingsChallangeView.swift
...
struct StateAndBindingsChallangeView: View {
    // MARK:- Directions
    /*
...
struct StateAndBindingsChallangeView_Previews: PreviewProvider {
    static var previews: some View {
        StateAndBindingsChallangeView()
    }
}
